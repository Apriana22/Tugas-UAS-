...
public class uas{
	public static void main(String[] args){
		...
		String nama_pengguna[]={"ap", "ana", "pasti"}, nama; 
		String passwd[]={"ri", "tamba", "bisa"}, sandi;
		System.out.println("==========================================================");
	...
	static void menu(){
		...
		System.out.println("5. Biodata Pemrogram                                      ");
		System.out.println("6. Menu Keluar                                            ");
		System.out.println("----------------------------------------------------------");
	...
	static void Kasir(){
		...
		static void Penjualan(){
			String barang[]={"Mie Gelas", "Es Crem", "Gorengan"};
			int harga[]={5000, 3000, 1000}, total;
		...
		static void Stok(){
			...
			System.out.println(" Mie Gelas                                      15        ");
			System.out.println("  Es Crem                                       10        ");
			System.out.println("  Gorengan                                      30        ");
			System.out.println("==========================================================");
			pauser.nextLine();
	...
	static void biodata(){
			System.out.println();
			System.out.println("NAMA   = Apriana Malinda Tamba");
			System.out.println("TTL    = Medan, 20 April 2001");
			System.out.println("ALAMAT = Jl Jala Asri Blok X No 16");
			System.out.println("AGAMA  = Kristen");
			System.out.println("STATUS = MAHASISWA POLITEKNIK KAMPAR");
			System.out.println("PRODI  = TEKNIK INFORMATIKA");
			System.out.println("NIM    = 202013021");
